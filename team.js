$(function() {
    $.blockUI({
        message: '<h1>Please Wait While Loading...</h1>'
      });
    $.ajax({
							...
							"<div class='c-content-person-1 c-option-2'>"+
								"<div class='c-caption c-content-overlay placeholder'>"+
									...
									"<div id='modal"+i+"' class='modal fade' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' aria-hidden='true'>"+
										"<div class='modal-dialog'>"+
											"<div class='modal-content c-square'>"+
												"<div class='modal-header'>"+
													...
													"</button>"+
													"<h4 class='modal-title' id='myModalLabel'>"+item.name_Eng+"</h4>"+
												"</div>"+
										...
										"</div>"+
									"</div>"+
									"<img src='assets/img/loading.gif' class='c-overlay-object img-responsive' id='memberpic"+i+"' alt='"+item.name_Eng+"'>"+
								"</div>"+
								"<div class='c-body'>"+
									"<div class='c-head clearfix'>"+
										"<div class='c-name c-font-uppercase c-font-bold'>"+item.name_Eng+"</div>";
										var linkedin = "";
										if(item.linkedIn) 
